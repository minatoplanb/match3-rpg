...
export const BOARD = {
  cols: 7,
  rows: 7,
  cellSize: 96,        // 7 * 96 = 672px wide — mobile-friendly large gems
  reservoirRows: 7,
  originX: 64,         // (800 - 672) / 2 = 64 → centered
  originY: 310,        // Compact top → more room for board
  gemRadius: 40,       // Visual radius of gem circles
};
...
export const FLOOR_ENCOUNTERS = {
  1:  { enemies: ['slime', 'goblin'],                   theme: 'grassland' },
  2:  { enemies: ['goblin', 'slime'],                   theme: 'grassland' },
  3:  { enemies: ['wolf', 'goblin_archer'],              theme: 'grassland' },
  4:  { enemies: ['goblin_archer', 'wolf'],              theme: 'grassland' },
  5:  { boss: 'ogre_king',                              theme: 'grassland' },
  6:  { enemies: ['scorpion', 'mummy'],                  theme: 'desert' },
  7:  { enemies: ['sand_mage', 'scorpion'],              theme: 'desert' },
  8:  { enemies: ['mummy', 'sand_mage'],                 theme: 'desert' },
  9:  { enemies: ['sand_mage', 'scorpion', 'mummy'],     theme: 'desert' },
  10: { boss: 'sand_wyrm',                              theme: 'desert' },
  11: { enemies: ['skeleton', 'ice_golem'],              theme: 'frostlands' },
  12: { enemies: ['ice_golem', 'frost_witch'],           theme: 'frostlands' },
  13: { enemies: ['frost_witch', 'skeleton'],            theme: 'frostlands' },
  14: { enemies: ['skeleton', 'frost_witch', 'ice_golem'], theme: 'frostlands' },
  15: { boss: 'lich_lord',                              theme: 'frostlands' },
  16: { enemies: ['imp', 'fire_elemental'],              theme: 'infernal' },
  17: { enemies: ['fire_elemental', 'demon_knight'],     theme: 'infernal' },
  18: { enemies: ['demon_knight', 'imp'],                theme: 'infernal' },
  19: { enemies: ['imp', 'fire_elemental', 'demon_knight'], theme: 'infernal' },
